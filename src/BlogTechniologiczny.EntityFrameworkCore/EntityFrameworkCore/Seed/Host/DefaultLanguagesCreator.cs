...
namespace BlogTechniologiczny.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BlogTechniologicznyConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(BlogTechniologicznyDbContext context)
        {
            _context = context;
        }
