...
{
    public abstract class BlogTechniologicznyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BlogTechniologicznyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BlogTechniologicznyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BlogTechniologicznyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BlogTechniologicznyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BlogTechniologicznyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BlogTechniologicznyDbContext, Task<T>> func)
        {
            T result;
